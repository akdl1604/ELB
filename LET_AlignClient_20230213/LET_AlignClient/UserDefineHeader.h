...
enum _ELB_INSP_ERROR_CODE {
	...
	ELB_INSP_ERROR_OVERFLOW_MIN,
	ELB_INSP_ERROR_OVERFLOW_MAX,
...
enum ELB_SEQNUM_NOZZLE_ALIGN_INSP_ALOGORITHM
{
	NOZZLE_ALIGN_CENTER_RESET = 0,
	NOZZLE_ALIGN_CENTER_GRAB = 10,
	NOZZLE_ALIGN_WAIT_OFF_REQ = 19,
	NOZZLE_ALIGN_RESET_FLAG = 120,
	NOZZLE_TIP_WAIT_OFF_REQ = 130,
};
...
private:
	...
	double m_dNozzleTipSizeSpec;
	double m_dNozzleTipSizeTolerance;
	...
	double m_dCGJudgeArea;
	bool m_bScratchInspThreadMode;
	bool m_bScratchInspPeriMode;
	double m_dLeftTopDistX;
	double m_dLeftTopDistY;
	double m_dInspWidth;
	double m_dInspHeight;	
    ...
    // YCS 2022-12-24 PN To Metal 측정모드 파라미터 추가
	bool m_bPanelToMetalCalcMode;

	// SJB 2023-01-02 CG to Start, End 파라미터 추가
	double m_dCgToStartSpec;
	double m_dCgToEndSpec;
	// KBJ 2023-01-11 OAM(Once AttachFilm Mode) 추가
	bool m_OAM_bUse;
	int m_OAM_nStageNum;
	double m_OAM_dFilmPositionX;
	double m_OAM_dFilmPositionY;
	double m_OAM_dRotateX;
	double m_OAM_dRotateY;
public:
	// 검사 Spec 
	...
	bool getFeriAlignFindPreProcFlag() { return iFeriAlignFindPreProc; }
	void setFeriAlignFindPreProcFlag(bool t) { iFeriAlignFindPreProc = t; }	
	...
	//SJB 2022-12-19 Nozzle Tip Size 파라미터 추가
	double getNozzleTipSizeSpec() { return m_dNozzleTipSizeSpec; }
	void setNozzleTipSizeSpec(double dVal) { m_dNozzleTipSizeSpec = dVal; }
	double getNozzleTipSizeSpecTolerance() { return m_dNozzleTipSizeTolerance; }
	void setNozzleTipSizeSpecTolerance(double dVal) { m_dNozzleTipSizeTolerance = dVal; }
	...
	bool getScratchInspThreadMode() { return m_bScratchInspThreadMode; }
	void setScratchInspThreadMode(bool nval) { m_bScratchInspThreadMode = nval; }

	bool getScratchInspPeriMode() { return m_bScratchInspPeriMode; }
	void setScratchInspPeriMode(bool nval) { m_bScratchInspPeriMode = nval; }

	double getScratchLeftTopDistX() { return m_dLeftTopDistX; }
	void setScratchLeftTopDistX(double nval) { m_dLeftTopDistX = nval; }
	double getScratchLeftTopDistY() { return m_dLeftTopDistY; }
	void setScratchLeftTopDistY(double nval) { m_dLeftTopDistY = nval; }
	double getScratchInspWidth() { return m_dInspWidth; }
	void setScratchInspWidth(double nval) { m_dInspWidth = nval; }
	double getScratchInspHeight() { return m_dInspHeight; }
	void setScratchInspHeight(double nval) { m_dInspHeight = nval; }
	...
	// YCS 2022-12-24 PN To Metal 측정모드 파라미터 추가
	bool getPanelToMetalCalcEnable() { return m_bPanelToMetalCalcMode; }
	void setPanelToMetalCalcEnable(bool bMode) { m_bPanelToMetalCalcMode = bMode; }

	// SJB 2023-01-02 CG to Start, End 파라미터 추가
	double getCgToStartSpec() { return m_dCgToStartSpec; }
	void setCgToStartSpec(double dValue) { m_dCgToStartSpec = dValue; }
	double getCgToEndSpec() { return m_dCgToEndSpec; }
	void setCgToEndSpec(double dValue) { m_dCgToEndSpec = dValue; }
	// JCY 2023-01-12 CG Judge Area 파라미터 추가
	double getCGJudgeArea() { return m_dCGJudgeArea; }
	void setCGJudgeArea(double nval) { m_dCGJudgeArea = nval; }
	
	// KBJ 2023-01-11 OAM(Once AttachFilm Mode) 추가
	bool getOAM_Use() { return m_OAM_bUse; }
	void setOAM_Use(bool bValue) { m_OAM_bUse = bValue; }
	int getOAM_Stage_Num() { return m_OAM_nStageNum; }
	void setOAM_Stage_Num(int iValue) { m_OAM_nStageNum = iValue; }
	double getOAM_FilmPosition_X() { return m_OAM_dFilmPositionX; }
	void setOAM_FilmPosition_X(double dValue) { m_OAM_dFilmPositionX = dValue; }
	double getOAM_FilmPosition_Y() { return m_OAM_dFilmPositionY; }
	void setOAM_FilmPosition_Y(double dValue) { m_OAM_dFilmPositionY = dValue; }
	double getOAM_Rotate_X() { return m_OAM_dRotateX; }
	void setOAM_Rotate_X(double dValue) { m_OAM_dRotateX = dValue; }
	double getOAM_Rotate_Y() { return m_OAM_dRotateY; }
	void setOAM_Rotate_Y(double dValue) { m_OAM_dRotateY = dValue; }
};
...
public:
	...
	// YCS 2023-01-07 PreAlign 패턴 변경
	bool m_bPatternType;
	long m_lPanelLength_X0;
	long m_lPanelLength_X1;
};
