		...
		else
		{
			...
			else
			{
				...
				case stProperty::VVT_STRING:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(CString*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_INT:		// Spin이 아닌 경우에는 무조건 정수는 long int로 처리해야함
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(long int)(*(int*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_LONG:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(long*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_SHORT:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(short*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_BYTE:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(BYTE*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_DWORD:
					if (stData.GetPropType() == stProperty::PROP_COLOR)
					{
						...
						pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(DWORD*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_DOUBLE:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(double*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_FLOAT:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(float*)pData), stData.GetItemDescName());
					break;
				case stProperty::VVT_BOOL:
					pNewProperty = new CPGridProperty(stData.GetItemName(), (_variant_t)(*(bool*)pData), stData.GetItemDescName());
					break;
				default:
					return nullptr;
				}
