...
void CAlignMeasureInspection::calcHistogram(cv::Mat& srcImage, int(&Histo)[256])
{
	int i, x, y;
...
void CAlignMeasureInspection::applyLUT(cv::Mat& srcImage, cv::Mat& dstImage, int(&LUT)[256])
{
...
void CAlignMeasureInspection::sobelDirection(int nMaskSize, int nDirection, cv::Mat& srcImage, cv::Mat& dstImage)
{
...
void CAlignMeasureInspection::endInSearch(cv::Mat& srcImage, cv::Mat& dstImage)
{
	int i;
