...
void CLabel::OnPaint() 
{
	...
	try
	{
		...
		//	pDCMem->SelectObject(pOldFont);		
			//	WinGdi.cpp  FromHandle() 하면서 에러가 나는 경우가 있음. 아래 두줄 참조
			//	CFont* CDC::SelectObject(CFont* pFont)	-->  return (CFont*)CGdiObject::FromHandle(hOldObj);
			//	-->  CGdiObject* PASCAL CGdiObject::FromHandle(HGDIOBJ h) -->	CGdiObject* pObject = (CGdiObject*)pMap->FromHandle(h);  
