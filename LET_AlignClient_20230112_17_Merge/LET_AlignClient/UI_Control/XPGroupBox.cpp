...
void CXPGroupBox::OnPaint() 
{
	...
	{
		// Jeong, 2015-03-06 : 텍스트 간격 수정(5)
		// Calculate Title size
		rectTitle.top = rectClient.top + 5;
		rectTitle.left = rectClient.left ;

		rectTitle.right = rectClient.right;
		rectTitle.bottom = rectClient.top + sizeText.cy + 4 + 5;
		...
		// Jeong, 2015-03-06 : 타이틀 간격 수정(10)
		// Draw content area
		rectContent.left = rectClient.left;
		rectContent.top = rectClient.top + sizeText.cy + 4 + 10;
		
		rectContent.right = rectClient.right;
		rectContent.bottom = rectContent.top + rectClient.Height() - sizeText.cy - 4 - 10;
