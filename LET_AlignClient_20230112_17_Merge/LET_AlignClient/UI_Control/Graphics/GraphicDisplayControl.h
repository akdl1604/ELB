...
#define ID_MENU_HIDE_INTGRAPHIC USER_ID + 17

#define ID_MENU_SAVE		    USER_ID + 18
#define ID_MENU_LOAD		    USER_ID + 19
#define ID_MENU_FIT			    USER_ID + 20
#define ID_MENU_NAVIGATION	    USER_ID + 21
